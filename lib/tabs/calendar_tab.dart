  ...
  void _create(BuildContext context) {
    ...
    var content = TextField(
      ...
      decoration: InputDecoration(
        ...
        labelText: 'What did you order & cost',
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("Log a Starbucks Visit", style: GoogleFonts.montserrat(
                      color: Color.fromRGBO(59, 57, 60, 1),
                      fontSize: 18,
                      fontWeight: FontWeight.bold)),
  ...
  Widget eventTitle(){
    if(_selectedEvents.length == 0){
      return Container(
        ...
        child:Text("No Visits Recorded. Click + sign to log a visit", style: Theme.of(context).primaryTextTheme.headline6),
      );
    }
    return Container(
      padding: EdgeInsets.fromLTRB(15, 20, 15, 15),
      child:Text("Visits to Starbucks", style: Theme.of(context).primaryTextTheme.headline6),
    );
  }
